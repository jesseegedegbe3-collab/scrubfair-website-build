  ...
  return (
    <div className="no-scroll-page grid h-full grid-cols-1 gap-3 p-3 md:grid-cols-12 md:gap-4 md:p-4">
      ...
      <motion.section
        ...
        className="flex h-full flex-col gap-3 overflow-hidden rounded-2xl border border-slate-200 bg-brand-sky-tint p-4 md:col-span-5 md:p-5"
      >
        <div>
...
function ReviewCard({
  ...
  return (
    <motion.article
      ...
      variants={fadeUp}
      custom={index}
      className="flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-3"
    >
...
function ReviewPlaceholderCard({ index }: { index: number }) {
  return (
    <motion.article
      ...
      variants={fadeUp}
      custom={index}
      className="flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-dashed border-slate-300 bg-white p-3"
    >
