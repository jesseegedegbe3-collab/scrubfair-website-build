  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul className="ml-4 list-disc space-y-1">
          <li>
            <strong>Convex</strong> (database hosting on AWS in North America) —
            to securely store your submission.
          </li>
          <li>
...
export function Privacy() {
  return (
    <div className="no-scroll-page flex h-full flex-col gap-3 p-3 md:gap-4 md:p-4">
      {/* Top: header strip + amber template banner side-by-side */}
      <motion.header
