...
export default function Home() {
  return (
    <div className="no-scroll-page grid h-full grid-cols-1 gap-3 p-3 md:grid-cols-12 md:gap-4 md:p-4">
      ...
      <section className="relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-bento-sky p-4 md:col-span-5 md:p-5 lg:col-span-5">
        <div
          aria-hidden
      ...
      {/* COLUMN 2 — Services */}
      <section className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-brand-sky-tint md:col-span-4 md:row-span-1 lg:col-span-3">
      ...
      <section className="flex flex-col gap-3 md:col-span-3 lg:col-span-4">
